...
Please review inviestgation perfomred so far and include important points required to ensure a smooth troubelshooting call with the customer.
...
- Steps to confirm the issue on the call
- Steps to explain the issue
